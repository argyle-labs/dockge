...
impl ::std::fmt::Display for DockgeError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            DockgeError::Http(e) => ::std::fmt::Display::fmt(e, f),
            DockgeError::MissingStack => f.write_str("missing 'stack' name"),
        }
    }
}

impl ::std::error::Error for DockgeError {
    fn source(&self) -> Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            DockgeError::Http(e) => Some(e),
            DockgeError::MissingStack => None,
        }
    }
}

impl From<HttpError> for DockgeError {
